...
export default function SalesOrderVoucher() {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setErrors }) => {
            ...
            try {
                if (formStatus == 2)
                    await axiosInstance.put(`/voucher/sales-order-voucher/${request_data.id}/`, request_data)
                else
    ...
    return (
        <MainCard title={formStatus && 'Add Sales Order Voucher' || 'Sales Order Vouchers'} formStatus={formStatus} setFormStatus={setFormStatus}>
            {
                formStatus ?
                    <>
                                                    ...
                                                    <Avatar
                                                        ...
                                                        onClick={() => {
                                                            if (confirm('Are you sure?')) {
                                                                (async () => {
                                                                    try {
                                                                        await axiosInstance.delete(`/voucher/sales-order-voucher/${voucher.id}/`)
