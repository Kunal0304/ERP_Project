...
export default function _3_CurrentAssetsLedger({ ledgerData, onLedgerUpdate, selectedGroup, setFormStatus, setLedgerData, nameFormik, setCancelForm }) {
    ...
    const formik = useFormik({
        initialValues: {
            ...
            opening_balance: currentLedgerData?.opening_balance || 0,
        ...
        onSubmit: async (values, { setErrors }) => {
            ...
            try {
                if (currentLedgerData) {
                    await axiosInstance.put(`/company/ledgers/current-assets/${currentLedgerData.id}/`, request_data);
                    ...
                    await axiosInstance.post('/company/ledgers/current-assets/', request_data);
