...
export default function _14_InvestmentsLedger({ ledgerData, onLedgerUpdate, selectedGroup, setFormStatus, setLedgerData, nameFormik, setCancelForm }) {
        ...
        onSubmit: async (values, { setErrors }) => {
            ...
            try {
                if (currentLedgerData) {
                    await axiosInstance.put(`/company/ledgers/investments/${currentLedgerData.id}/`, request_data);
                    ...
                    await axiosInstance.post('/company/ledgers/investments/', request_data);
