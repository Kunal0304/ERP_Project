...
export default function _10_ExpensesIndirectLedger({ ledgerData, onLedgerUpdate, selectedGroup, setFormStatus, setLedgerData, nameFormik, setCancelForm }) {
        ...
        onSubmit: async (values, { setErrors }) => {
            ...
            try {
                if (currentLedgerData) {
                    await axiosInstance.put(`/company/ledgers/expenses-indirect/${currentLedgerData.id}/`, request_data);
                    ...
                    await axiosInstance.post('/company/ledgers/expenses-indirect/', request_data);
